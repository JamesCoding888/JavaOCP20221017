...
/*
	...
	Just in case of 2 abstraction method existed in one interface class, the compiler will present the error message as follows:
	...
	如果有 2 個以上之抽象方法，則 compiler 時，會出現錯誤訊息，如下: 
	"Invalid '@FunctionalInterface' annotation; Calc is not a functional interface"
	==============================================================================================================================================================================
*/
@FunctionalInterface
