...
public class LocalVariableInvokedByInnerClass {
	...
	public String print() {
		...
		/*
		 	==========================================================================================================================
		 	If local variable expected to be invoked by Inner class, its value MUST be like characteristic as final, 
			...
			===========================================================================================================================
			若區域變數，欲被內部類別調用，其區域變數的值，必須具備 final 的特性，也就是說，此區域變數必須是常數。即使區域變數不宣告為 final，
