...
public class PathReader2 {
	public static void main(String[] args) {      	    
		String path = "/Users/../../repository/JavaOCP20221017/src/main/java/com/ocp/day21/io/data/lottery.txt";
        ...
        Path path2 = Paths.get("src/main/java/com/ocp/day21/io/data/lottery.txt");
        ...
        Path targePath = Paths.get("/JavaOCP20221017/src/main/java/com/ocp/day21/io/data/lottery.txt"); 
        ...
        Path path3 = Paths.get("/Users/liaojames/git/repository/JavaOCP20221017/src/main/java/com/ocp/day21/io/data/lottery.txt");
        // Check whether path3 starts with the root path
        Path root = Paths.get("/Users");
        // Check whether path3 ends with the file path.
        Path file = Paths.get("lottery.txt"); 
...
/*
	Console: 
			/repository/JavaOCP20221017/src/main/java/com/ocp/day21/io/data/lottery.txt
			/Users/liaojames/git/repository/JavaOCP20221017/src/main/java/com/ocp/day21/io/data/lottery.txt
			src/main/java/com/ocp/day21/io/data/lottery.txt
			../../../../../../../../..
			true
			true
*/