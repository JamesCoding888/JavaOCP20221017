...
/*
	...
	The menu of Order System is almost to be DONE, but suddenly your client request additional function which could query the flavors and price of meal. 
	...
	那為什麼選用抽象類別，因為抽象類別無法將物件實體化，也就是不可從任意類別中，使用 new AgentOfFood()，其原因是，抽象類別出現，係為了由子累別實體化的物件，來呼叫抽象類別中的變數或方法，
	如此，可避免去修改既有程式碼的商業邏輯，只需讓其原來的類別去繼承抽象類別，這樣既不會改動原來的架構
